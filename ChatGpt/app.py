...
% python gptwebapp.py
'''
# $python gptwebapp.py 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
...
app = Flask(__name__)
g = GPT((os.environ.get('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')))


@app.route('/')
@app.route('/<name>')
def home(name='Yishan'):
...
def index():
    ...
    return f'''
        ...
        <ul>
            ...
            <li><a style="font-family:verdana;font-size:25px" href="{url_for('home', name='Yishan')}">Yishan</a></li>
        </ul>
        <a style="font-family:verdana;font-size:20px" href="{url_for('home', name=name)}">Back to main</a>
    '''
